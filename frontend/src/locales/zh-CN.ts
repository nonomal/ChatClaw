export default {
  ...
  settings: {
    ...
    skills: {
      ...
      noSkills: '暂无技能',
      noSkillsHint: '点击"市场"标签页浏览并安装技能',
      noLocalSkills: '暂无技能',
      noLocalSkillsHint: '手动在 skill 目录创建一个文件夹，创建一个 SKILL.md，按照 skill 规范编写，创建本地技能',
      addLocalSkill: '添加',
      addLocalSkillHint: '手动在 skill 目录创建一个文件夹，创建一个 SKILL.md，按照 skill 规范编写，创建本地技能',
    ...
    mcp: {
      ...
      addServer: '添加',
      validateAll: '校验所有已启用的 MCP 服务',
      validateAllPassed: '所有已启用的 MCP 服务校验通过',
      validateDisabled: '已自动关闭 {count} 个不可用的 MCP 服务',
      editServer: '编辑 MCP 服务',
      addServerTitle: '添加 MCP 服务',
      serverName: '名称',
      serverNamePlaceholder: '输入服务名称',
      description: '描述',
      descriptionPlaceholder: '输入 MCP 服务的简要描述',
      transportType: '传输类型',
      ...
      assistantMcpName: 'MCP 插件名称',
      assistantMcpNamePlaceholder: '输入 MCP 插件名称',
      assistantMcpDescription: '描述',
      assistantMcpDescriptionPlaceholder: '输入 MCP 插件的简要描述',
      ...
      assistantMcpLinkAgentsDesc: '选择要作为此 MCP 工具的 AI 助手',
  ...
  assistant: {
    ...
    workspaceDrawer: {
      ...
      mcpAddFromGlobal: '从全局 MCP 列表添加',
      mcpEmptyHint: '点击 + 从全局 MCP 列表添加',
      mcpPickerHint: '开启开关将 MCP 加入当前助手，关闭则移除',
      mcpNoAvailableToAdd: '暂无可添加的 MCP 服务，请先在设置中启用',
