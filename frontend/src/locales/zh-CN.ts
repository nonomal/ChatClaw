export default {
  ...
  settings: {
    ...
    skillMarket: {
      ...
      addSkillHintDescAgent: '在 {dir} 目录中创建新文件夹，并添加 SKILL.md 文件来创建此 Agent 的技能。',
      addSkillViaChatPrompt: '我想创建一个新的 AI 技能，请帮我设计技能的名称、描述、功能和实现方案。技能将安装在 Agent #{agentId}（{agentName}）的工作目录 {dir} 中。',
      addSkillViaChatPromptShared: '我想创建一个新的 AI 技能，请帮我设计技能的名称、描述、功能和实现方案。技能将安装在共享技能目录 {dir} 中。',
