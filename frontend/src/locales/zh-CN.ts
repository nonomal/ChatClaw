export default {
  ...
  settings: {
    ...
    skillMarket: {
      ...
      addSkillHint: '添加共享技能',
      addSkillHintDesc: '在打开的目录中创建新文件夹，并添加 SKILL.md 文件来创建共享技能。',
      addSkillHintDescShared: '在 {dir} 目录中创建新文件夹，并添加 SKILL.md 文件来创建共享技能。',
      addSkillHintDescAgent:
        '在 {dir} 目录中创建新文件夹，并添加 SKILL.md 文件来创建此 Agent 的技能。',
      addSkillViaChatPrompt:
        '我想创建一个新的 AI 技能，请帮我设计技能的名称、描述、功能和实现方案。技能将安装在 Agent #{agentId}（{agentName}）的工作目录 {dir} 中。',
      addSkillViaChatPromptShared:
        '我想创建一个新的 AI 技能，请帮我设计技能的名称、描述、功能和实现方案。技能将安装在共享技能目录 {dir} 中。',
      addSkillDialogTitle: '添加技能',
      addSkillViaChatTitle: '通过对话创建',
      addSkillViaChatDesc: '与 AI 对话，让它帮你设计技能名称、描述和实现方案。',
      addSkillViaChatGuideLabel: '访问 SkillHub',
      addSkillViaChatGuideDesc: '搜索需要的技能，复制安装提示到 Agent 中发送。',
      addSkillChoosePackageTitle: '选择技能包',
      addSkillChoosePackageDesc: '打开对应目录，将下载好的技能包放入其中。',
      addSkillChoosePackageGuideLabel: '访问 ClawHub',
      addSkillChoosePackageGuideDesc: '搜索需要的技能，并将安装文件下载到对应目录下。',
      agentWorkspaceDirLoading: '加载目录...',
      agentWorkspaceDirHint: '请先选择一个 Agent',
      scopeSharedOption: '共享技能',
      scopeAgentOption: 'Agent 技能',
      statusInstalled: '已安装',
      statusInstalling: '安装中',
      actionInstallSkill: '安装技能',
      introTitle: '技能介绍',
      usageTitle: '怎么使用？',
      securityVerifiedHint: '已通过安全与合规验证，无恶意代码或数据泄露风险。',
      viewDetail: '查看详情',
      badgeBuiltIn: '内置技能',
      badgeWorkspace: '工作区',
      syncFailedTitle: '技能市场同步失败',
      syncFailedDescription: '无法连接到后端服务',
    },
    mcp: {
      title: 'MCP',
      enable: '启用 MCP',
    ...
    chatwiki: {
      title: 'ChatWiki',
      description: '授权绑定chatwiki，获取机器人和对应的知识库，绑定云版账号同时支持使用自有模型和积分',
      openclawDescription: '授权绑定chatwiki，使用chatwiki自有模型和账号积分',
      notBound: '暂未绑定',
      bound: '已绑定',
      bindingExpired: '已过期',
      reauthBind: '重新授权绑定',
      ...
      loginNow: '立即登录',
      switchBinding: '切换绑定',
      openSourceVersionLogin: '开源版账号',
      openSourceVersionHint: '仅支持知识库/应用同步',
      cloudVersion: '云版',
      ...
      openSourceLoginHint: '当前登录账号为开源版账号，不支持使用chatwiki自有模型和积分',
      providerStatus: {
        unbound: '{label}（未登录）',
        nonCloud: '{label}（未登录）',
      },
  ...
  assistant: {
    ...
    chat: {
      ...
      knowledgeChipRemoveNotSupported: '当前模式不支持移除',
      selectImages: '选择图片',
      ...
      taskAgentType: '智能体类型',
      taskAgentResult: '子智能体结果',
      subAgentPrefix: '子任务',
      subAgentGeneralPurpose: '子任务 · 智能体',
      subAgentBash: '子任务 · 终端',
      subAgentRunning: '运行中',
  ...
  knowledge: {
    ...
    content: {
      ...
      relearn: {
        success: '已开始重新学习',
        successBatch: '已开始重新学习 {count} 个文档',
        failed: '重新学习失败',
      },
      delete: {
        title: '确认删除',
        desc: '确定要删除文档「{name}」吗？此操作无法撤销。',
        descBatch: '确定要删除选中的 {count} 个文档吗？此操作无法撤销。',
        cancel: '取消',
        confirm: '删除',
        success: '删除成功',
        successBatch: '已删除 {count} 个文档',
        failed: '删除失败',
      },
      moveToFolder: {
        title: '移动到文件夹',
    ...
    folder: {
      ...
      deleteConfirm: '删除',
      deleteSuccess: '删除成功',
      deleteSuccessBatch: '已删除 {count} 个文件夹',
      move: {
        title: '移动文件夹',
        titleBatch: '批量移动文件夹（{count}）',
        action: '移动',
        selectFolder: '选择目标文件夹',
        moveToHere: '移动到此',
        success: '移动成功',
        successBatch: '已成功移动 {count} 个文件夹',
        failed: '移动失败',
      },
      deleteFailed: '删除失败',
  ...
  channels: {
    ...
    wecomAdd: {
      title: '配置企微',
      subtitle: '通过腾讯官方 OpenClaw 插件扫码连接企业微信，同时支持接入已有机器人。',
      howTitle: '如何连接',
      tipsIntro: '通过腾讯官方 OpenClaw 插件扫码连接企业微信，同时支持接入已有机器人。',
      stepsLabel: '步骤',
    ...
    meta: {
      ...
      discord: {
        name: 'Discord',
        botName: 'Discord',
        description: 'Discord 机器人，通过网关接入',
      },
      whatsapp: {
        name: 'WhatsApp',
        botName: 'WhatsApp',
  ...
  openclawCron: {
    ...
    history: {
      ...
      detailLoadFailedReason: '请确认 OpenClaw 网关已启动，并稍后重试。',
