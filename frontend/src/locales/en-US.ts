export default {
  ...
  settings: {
    ...
    mcp: {
      ...
      addServer: 'Add',
      validateAll: 'Validate all enabled MCP servers',
      validateAllPassed: 'All enabled MCP servers passed validation',
      validateDisabled: '{count} unavailable MCP server(s) have been disabled',
      editServer: 'Edit MCP Server',
      addServerTitle: 'Add MCP Server',
      serverName: 'Name',
      serverNamePlaceholder: 'Enter server name',
      description: 'Description',
      descriptionPlaceholder: 'Brief description of this MCP server',
      ...
      inspectFailed: 'Failed to inspect MCP server',
      ...
      assistantMcpNamePlaceholder: 'Enter MCP plugin name',
      assistantMcpDescription: 'Description',
      assistantMcpDescriptionPlaceholder: 'Brief description of this MCP plugin',
      assistantMcpUrl: 'URL',
      assistantMcpAuth: 'Authorization',
      assistantMcpAutoPort: 'Port auto-assigned after creation',
      assistantMcpAuthNone: 'Bearer Token',
      assistantMcpNoItems: 'No Assistant MCP configured',
      assistantMcpNoItemsHint: 'Click the "Add" button to configure an MCP service',
  ...
  assistant: {
    ...
    channels: {
      ...
      subtitle: 'Add and bind messaging channels for "{name}"',
    ...
    workspaceDrawer: {
      ...
      mcpAddFromGlobal: 'Add from global MCP list',
      mcpEmptyHint: 'Click + to add from global MCP list',
      mcpPickerHint: 'Toggle to add or remove MCP servers for this agent',
      mcpNoAvailableToAdd: 'No MCP servers available to add. Enable some in Settings first.',
  ...
  channels: {
    ...
    // Display names for ChannelService.GetSupportedPlatforms() (keyed by platform id)
    platforms: {
      dingtalk: 'DingTalk',
      feishu: 'Feishu',
      wecom: 'WeCom',
