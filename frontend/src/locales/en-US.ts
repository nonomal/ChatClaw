export default {
  ...
  channels: {
    ...
    wecomAdd: {
      ...
      step3: 'Also supports connecting an existing bot',
    ...
    wechat: {
      ...
      step4: '3. Scan the QR code below with WeChat and confirm the connection on your phone',
      step5: '4. After a successful connection, a new "WeChat ClawBot" conversation will appear automatically in WeChat. You can go through the scan flow again to add more WeChat accounts, or reconnect an existing account.',
      ...
      qrExpired: 'Expired',
      qrExpiredHint:
        'The QR code is no longer valid or the wait timed out. Tap Refresh below to get a new one.',
