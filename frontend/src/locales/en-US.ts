export default {
  ...
  settings: {
    ...
    general: {
      ...
      toolchain: {
        ...
        uv: {
          name: "Python Runtime",
          description: "Enable the AI assistant to write and run Python scripts to complete complex tasks.",
        },
        bun: {
    ...
    memory: {
      ...
      rebuildWarning: "After modifying the vector model or dimension, all existing memory vector data will be asynchronously rebuilt.",
    },
    skills: {
      title: "Skills",
      ...
      noLocalSkillsHint: "Create a folder in the skill directory, add a SKILL.md file following the skill specification to create a local skill",
      addLocalSkill: "Add",
      addLocalSkillHint: "Create a folder in the skill directory, add a SKILL.md file following the skill specification to create a local skill",
      ...
      directoryHint: "Place the downloaded skill folder in this directory. AI will automatically recognize and load it during conversations.",
    ...
    modelService: {
      ...
      capabilityFile: "File",
      deleteBlockedByAgent: "This model is currently used as the default model by assistant \"{name}\". Please modify the assistant settings first before deleting.",
      deleteConfirmMessage: "Are you sure you want to delete the model \"{name}\"? This action cannot be undone.",
      disableBlockedByAgent: "This provider is currently used as the default model by assistant \"{name}\". Please modify the assistant settings first before disabling.",
    },
  },
  assistant: {
    ...
    channels: {
      ...
      createDesc: "Reuse the channel creation flow and automatically bind the result to the current agent.",
    ...
    settings: {
      ...
      workspace: {
        ...
        nativeDesc: "Execute commands directly on this machine without sandbox isolation. Commands have full permissions of the current user.",
  ...
  knowledge: {
    help: {
      ...
      chunkOverlap: "Overlap size between adjacent chunks (characters, 0-1000). Used to reduce information loss caused by cross-chunk sentence breaking.",
      chunkSize: "Chunk size (characters, 500-5000). Larger chunks provide more complete context, but result in coarser recall granularity.",
    },
    tabs: {
      personal: "Personal",
      team: "Team",
    ...
    folder: {
      ...
      deleteDesc: "After deleting the folder \"{name}\", documents under it will be moved to \"Ungrouped\". This action cannot be undone.",
      parentFolderHelp: "Select a parent folder to create nested folders. Leave empty to create in the root directory.",
    },
    detail: {
  ...
  memory: {
    ...
    loadingMore: "Loading…",
    noMore: "No more",
    deleteEventStreamConfirm: "Are you sure you want to delete this conversation record? This action cannot be undone.",
  ...
  channels: {
    ...
    toggle: {
      ...
      enableDesc: "When enabled, the system will try to connect and receive messages from this channel.",
      disableDesc: "When disabled, the connection will be closed and messages from this channel will no longer be received.",
    },
    status: {
      online: "Connected",
      error: "Error",
