export default {
  ...
  channels: {
    ...
    wechat: {
      ...
      step3:
        'After a successful connection, a new "WeChat ClawBot" conversation will appear automatically in WeChat. You can go through the scan flow again to add more WeChat accounts, or reconnect an existing account.',
