export default {
  ...
  openclawCron: {
    ...
    history: {
      title: 'Run History',
      waitingTriggeredRun:
        'The task has been triggered. Waiting for OpenClaw to write a new run record...',
      ...
      detailLoadFailedDescription:
        'Unable to load the conversation details for this run. Please check OpenClaw status and try again.',
