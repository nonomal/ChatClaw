export default {
  ...
  settings: {
    ...
    skillMarket: {
      ...
      addSkillHintDesc: 'Create a new folder in the opened directory and add a SKILL.md file to create a shared skill.',
      addSkillHintDescShared: 'Create a new folder in {dir} and add a SKILL.md file to create a shared skill.',
      addSkillHintDescAgent: 'Create a new folder in {dir} and add a SKILL.md file for this Agent\'s skill.',
      addSkillViaChatPrompt: 'I want to create a new AI skill, please help me design the skill name, description, features and implementation. The skill will be installed in Agent #{agentId} ({agentName})\'s workspace directory {dir}.',
      addSkillViaChatPromptShared: 'I want to create a new AI skill, please help me design the skill name, description, features and implementation. The skill will be installed in the shared skills directory {dir}.',
