export default {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      emptyDesc: "OpenClaw 내장 WhatsApp 채널로 QR 코드를 스캔해 WhatsApp(WhatsApp Web)에 연결합니다.",
      addNow: "지금 추가",
      configTitle: "WhatsApp 설정",
      howToConnect: "연결 방법",
      step1: "아래 버튼을 누르면 필요 시 OpenClaw에서 내장 WhatsApp 채널을 활성화합니다.",
      step2: "이어서 앱이 백그라운드에서 QR 로그인을 진행합니다. 휴대폰의 WhatsApp으로 QR 코드를 스캔하세요.",
      step3: "로그인 후 이 페이지에서 도우미를 연결하고 상태를 관리할 수 있습니다. 채널을 삭제하면 로그아웃되고 바인딩이 해제됩니다.",
      ...
      channelNotFound: "해당 채널을 찾을 수 없습니다. 새로고침 후 다시 시도하세요.",
      editNotSupported: "WhatsApp은 QR 스캔으로 연결되므로 여기서 편집할 수 없습니다. 계정을 바꾸려면 이 채널을 삭제한 뒤 다시 추가하세요.",
    },
  },
  scheduledTasks: {
    title: "예약 작업",
