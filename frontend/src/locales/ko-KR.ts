export default {
  ...
  settings: {
    ...
    openclawRuntime: {
      ...
      startSteps: {
        resolvedRuntime: '런타임 위치 확인됨: {path}',
        hotfixApplied: '핫픽스 {count}개 파일 적용됨',
        stoppedExisting: '기존 프로세스 중지됨',
        verifiedInstall: '설치 버전 {version} 확인됨',
        ensuredStateDir: '런타임 상태 디렉터리 초기화됨',
        adoptingExisting: '기존 게이트웨이 재사용 (PID: {pid})',
        startedProcess: '게이트웨이 프로세스 시작 중 (포트: {port})',
        existingProcessReused: '기존 프로세스 재사용 중 (PID: {pid})',
        connecting: 'WebSocket 연결 중 (포트: {port})',
        autoApproved: '디바이스 페어링 자동 승인됨',
        connected: '게이트웨이 연결됨',
      },
      phase: {
        idle: '대기 중',
    ...
    chatwiki: {
      ...
      loginNow: '지금 로그인',
      openSourceVersionLogin: '오픈소스 버전',
      openSourceVersionHint: 'KB/앱 동기화만 지원',
      cloudVersion: '클라우드',
      openSourceVersion: '오픈소스',
      ...
      wechat: '공식 계정 지식베이스',
      workflow: '워크플로',
      modelLoginHint: '먼저 ChatWiki 계정에 로그인하고 바인딩하세요. 최신 모델 서비스 목록이 여기에 표시됩니다.',
    ...
    skillMarket: {
      ...
      targetLocal: '로컬 디렉터리',
      targetOpenClawShared: 'OpenClaw 공유 스킬',
      targetOpenClawWorkspace: 'OpenClaw 워크스페이스',
      ...
      loadMore: '더 보기',
      noSkills: '스킬이 없습니다',
      noSkillsHint: '다른 카테고리나 검색어를 시도해 보세요',
      sourceClawhub: 'ClawHub',
      sourceSkillhub: 'SkillHub',
      sourceChatclaw: 'ChatClaw',
      loadFailed: '불러오기에 실패했습니다. 잠시 후 다시 시도해 주세요',
      installSuccess: '설치되었습니다',
      installFailed: '설치에 실패했습니다',
      uninstallSuccess: '제거되었습니다',
  ...
  knowledge: {
    ...
    content: {
      ...
      relearn: {
        ...
        successBatch: '{count}개 문서 다시 학습을 시작했습니다',
        failed: '다시 학습하지 못했습니다',
      },
      delete: {
        title: '삭제 확인',
        desc: '이 문서를 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
        descBatch: '선택한 {count}개 문서를 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
        cancel: '취소',
        confirm: '삭제',
        success: '삭제됨',
        successBatch: '{count}개 문서를 삭제했습니다',
        failed: '삭제하지 못했습니다',
      },
      moveToFolder: {
        title: '폴더로 이동',
        ...
        success: '이동 성공',
        successBatch: '{count}개 문서를 이동했습니다',
        failed: '이동 실패',
      },
  ...
  channels: {
    ...
    wechat: {
      ...
      howToConnect: '연결 방법',
      tipsIntro: 'Tencent 공식 OpenClaw 플러그인으로 QR 코드를 스캔해 개인 WeChat을 연결합니다',
      stepsLabel: '단계',
      step1: 'QR 코드 생성을 클릭하면 OpenClaw에 공식 WeChat 플러그인이 설치되고 활성화됩니다',
      step2: '아래 QR 코드를 WeChat으로 스캔하고 휴대폰에서 연결을 확인하세요',
