export default {
  ...
  channels: {
    ...
    wechat: {
      ...
      howToConnect: '연결 방법',
      step1: '1. Tencent 공식 OpenClaw 플러그인으로 QR 코드를 스캔해 개인 WeChat을 연결합니다',
      step3: '2. QR 코드 생성을 클릭하면 OpenClaw에 공식 WeChat 플러그인이 설치되고 활성화됩니다',
      step4: '3. 아래 QR 코드를 WeChat으로 스캔하고 휴대폰에서 연결을 확인하세요',
      step5: '4. 연결에 성공하면 WeChat에 새로운 "WeChat ClawBot" 대화가 자동으로 표시됩니다. 이후 다시 스캔 절차를 통해 더 많은 WeChat 계정을 추가하거나 기존 계정을 다시 연결할 수 있습니다.',
      ...
      qrExpired: '만료됨',
      qrExpiredHint:
        'QR 코드가 만료되었거나 대기 시간이 초과되었습니다. 아래 새로고침으로 다시 받으세요.',
