export default {
  ...
  channels: {
    ...
    wecomAdd: {
      ...
      step3: 'मौजूदा बॉट को जोड़ने का भी समर्थन',
    ...
    wechat: {
      ...
      step4: '3. नीचे दिया गया QR कोड WeChat से स्कैन करें और अपने फोन पर कनेक्शन की पुष्टि करें',
      step5: '4. कनेक्शन सफल होने के बाद WeChat में स्वचालित रूप से नई "WeChat ClawBot" बातचीत दिखेगी। बाद में आप स्कैन प्रक्रिया दोहराकर और WeChat खाते जोड़ सकते हैं या किसी मौजूदा खाते को फिर से कनेक्ट कर सकते हैं।',
