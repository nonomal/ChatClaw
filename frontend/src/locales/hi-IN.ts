export default {
  ...
  channels: {
    ...
    wecom: {
      ...
      emptyDesc: "Tencent के आधिकारिक OpenClaw प्लगइन से QR कोड स्कैन करके WeCom कनेक्ट करें या मौजूदा बॉट को एकीकृत करें।",
    },
    wechat: {
      ...
      qrExpiredHint: "QR कोड अब मान्य नहीं है या प्रतीक्षा समय समाप्त हो गया। नया प्राप्त करने के लिए नीचे \"रीफ़्रेश\" दबाएँ।",
    },
    whatsapp: {
      emptyTitle: "WhatsApp अभी जोड़ा नहीं गया",
      emptyDesc: "OpenClaw के अंतर्निहित WhatsApp चैनल से QR स्कैन करके WhatsApp (WhatsApp Web) कनेक्ट करें।",
      addNow: "अभी जोड़ें",
      configTitle: "WhatsApp कॉन्फ़िगर करें",
      howToConnect: "कनेक्ट कैसे करें",
      step1: "नीचे बटन दबाने के बाद ऐप ज़रूरत होने पर OpenClaw में अंतर्निहित WhatsApp चैनल सक्षम करता है।",
      step2: "फिर ऐप पृष्ठभूमि में QR लॉगिन चलाता है; अपने फ़ोन पर WhatsApp से QR कोड स्कैन करें।",
      step3: "लॉगिन के बाद इस पेज पर असिस्टेंट बाइंड करें। चैनल हटाने पर लॉगआउट होगा और बाइंडिंग हट जाएगी।",
      ...
      qrExpiredHint: "QR कोड समाप्त हो गया या प्रतीक्षा समय समाप्त हो गया। नया प्राप्त करने के लिए नीचे \"रीफ़्रेश\" दबाएँ।",
      loginSuccess: "WhatsApp कनेक्ट हो गया",
      pluginInstallTryLater: "WhatsApp चैनल अभी सक्षम हो रहा है या तैयार नहीं है। कृपया बाद में पुनः प्रयास करें।",
      channelNotFound: "संबंधित चैनल नहीं मिला। रीफ़्रेश करके फिर कोशिश करें।",
      editNotSupported: "WhatsApp QR स्कैन से कनेक्ट होता है, यहाँ संपादित नहीं किया जा सकता। खाता बदलने के लिए इस चैनल को हटाकर फिर जोड़ें।",
    },
  },
  scheduledTasks: {
