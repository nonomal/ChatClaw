export default {
  ...
  channels: {
    ...
    wechat: {
      ...
      tipsIntro: 'Tencent के आधिकारिक OpenClaw प्लगइन से QR कोड स्कैन करके अपना व्यक्तिगत WeChat कनेक्ट करें',
      stepsLabel: 'चरण',
      step1: 'QR कोड जनरेट करें पर क्लिक करें; OpenClaw में आधिकारिक WeChat प्लगइन इंस्टॉल और सक्षम होगा',
      step2: 'नीचे दिया गया QR कोड WeChat से स्कैन करें और अपने फोन पर कनेक्शन की पुष्टि करें',
      step3:
        'कनेक्शन सफल होने के बाद WeChat में स्वचालित रूप से नई "WeChat ClawBot" बातचीत दिखेगी। बाद में आप स्कैन प्रक्रिया दोहराकर और WeChat खाते जोड़ सकते हैं या किसी मौजूदा खाते को फिर से कनेक्ट कर सकते हैं।',
      ...
      qrExpired: 'समाप्त',
      qrExpiredHint:
        'QR कोड अब मान्य नहीं है या प्रतीक्षा समय समाप्त हो गया। नया कोड पाने के लिए नीचे रिफ्रेश दबाएँ।',
