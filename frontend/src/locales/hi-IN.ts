export default {
  ...
  settings: {
    ...
    general: {
      ...
      toolchain: {
        ...
        uv: {
          name: "Python रनटाइम",
          description: "AI असिस्टेंट को जटिल कार्य पूरा करने के लिए Python स्क्रिप्ट लिखने और चलाने में सक्षम बनाता है।",
        },
        bun: {
          name: "JavaScript रनटाइम",
          description: "AI असिस्टेंट को जटिल कार्य पूरा करने के लिए JavaScript स्क्रिप्ट लिखने और चलाने में सक्षम बनाता है।",
        },
        codex: {
          name: "सिक्योरिटी सैंडबॉक्स",
          description: "सिस्टम को अनजाने परिवर्तनों से बचाने के लिए अलग वातावरण में कमांड चलाता है।",
        },
    ...
    memory: {
      ...
      enableHint: "सक्षम होने पर, AI बातचीत के दौरान आपकी प्राथमिकताओं, आदतों और महत्वपूर्ण तथ्यों को स्वचालित रूप से याद करेगा।",
      extractModel: "मेमोरी एक्सट्रैक्शन मॉडल",
      extractModelHint: "प्रत्येक बातचीत के बाद मूल्यवान मेमोरी जानकारी को सारांशित और निकालने के लिए उपयोग किया जाता है।",
      embeddingModel: "मेमोरी एम्बेडिंग मॉडल",
      embeddingModelHint: "बातचीत के दौरान सिमांटिक रिट्रीवल के लिए मेमोरी टेक्स्ट को वेक्टर में बदलने के लिए उपयोग किया जाता है।",
      ...
      rebuildWarning: "एम्बेडिंग मॉडल या डाइमेंशन बदलने के बाद, सभी मौजूदा मेमोरी वेक्टर डेटा असिंक्रोनस रीबिल्ड होगा।",
    ...
    skills: {
      ...
      enableHint: "सक्षम होने पर, AI असिस्टेंट बातचीत के दौरान स्वचालित रूप से इंस्टॉल स्किल्स लोड और उपयोग करेगा।",
      pageDesc: "AI क्षमताओं को ब्राउज़ और प्रबंधित करें",
      directory: "स्किल लोड डायरेक्टरी",
      directoryHint: "डाउनलोड की गई स्किल फोल्डर इस डायरेक्टरी में रखें। AI बातचीत के दौरान वे स्वचालित रूप से पहचाने और लोड होंगे।",
      ...
      noLocalSkillsHint: "स्किल डायरेक्टरी में एक फोल्डर बनाएं, SKILL.md फाइल बनाएं, और स्किल स्पेसिफिकेशन का पालन करके लोकल स्किल बनाएं",
      addLocalSkill: "जोड़ें",
      addLocalSkillHint: "स्किल डायरेक्टरी में एक फोल्डर बनाएं, SKILL.md फाइल बनाएं, और स्किल स्पेसिफिकेशन का पालन करके लोकल स्किल बनाएं",
    ...
    chatwiki: {
      ...
      unbindConfirmDesc: "अनबाइंड करने के बाद, आपके पास ChatWiki ऐप्स और नॉलेज बेस तक पहुंच नहीं होगी। क्या आप सुनिश्चित हैं?",
    ...
    modelService: {
      enabled: "सक्षम",
      disableBlockedByEmbedding: "यह प्रोवाइडर ग्लोबल एम्बेडिंग मॉडल के रूप में उपयोग हो रहा है। अक्षम करने से पहले कृपया ",
  ...
  assistant: {
    ...
    channels: {
      ...
      createDesc: "चैनल बनाने का प्रवाह पुनः उपयोग करें और परिणाम को स्वचालित रूप से वर्तमान एजेंट से बाइंड करें।",
      ...
      addBot: "बॉट जोड़ें",
      addBotHint: "प्रत्येक बॉट केवल एक AI असिस्टेंट से बाइंड हो सकता है। केवल अनबाइंड बॉट दिखाए जाते हैं।",
    ...
    errors: {
      ...
      modelNotSupportVision: "वर्तमान मॉडल इमेज रिकग्निशन सपोर्ट नहीं करता। कृपया मल्टीमॉडल विज़न मॉडल पर स्विच करें",
    ...
    settings: {
      ...
      workspace: {
        ...
        codexDesc: "OpenAI Codex CLI द्वारा प्रदान OS-स्तरीय सैंडबॉक्स में कमांड एक्जीक्यूट करें। कमांड केवल वर्किंग डायरेक्टरी के भीतर फाइलें लिख सकते हैं; शेष फाइलसिस्टम केवल-पढ़ने के लिए है।",
        codexNotInstalled: "सिक्योरिटी सैंडबॉक्स अभी तक इंस्टॉल नहीं है। सैंडबॉक्स मोड अस्थायी रूप से अनुपलब्ध है और नेटिव एक्जीक्यूशन पर वापस आ जाएगा। आप इसे सेटिंग्स → सामान्य → एक्सटेंशन में इंस्टॉल कर सकते हैं।",
        nativeDesc: "सैंडबॉक्स आइसोलेशन के बिना होस्ट मशीन पर सीधे कमांड एक्जीक्यूट करें। कमांड के पास वर्तमान उपयोगकर्ता की पूर्ण अनुमतियां हैं।",
        networkAccess: "नेटवर्क एक्सेस की अनुमति दें",
        networkAccessDesc: "सक्षम होने पर, सैंडबॉक्स के अंदर कमांड नेटवर्क एक्सेस कर सकते हैं (जैसे npm install, pip install)। अक्षम होने पर, कमांड नेटवर्क एक्सेस नहीं कर सकते, जो अधिक सुरक्षित है।",
        workDir: "वर्किंग डायरेक्टरी",
        workDirDesc: "सभी सत्र आउटपुट और फाइलें इस डायरेक्टरी में सहेजी जाएंगी। प्रत्येक बातचीत sessions/ के नीचे एक सबफोल्डर बनाती है।",
    ...
    workspaceDrawer: {
      ...
      mcpNoAvailableToAdd: "जोड़ने के लिए कोई MCPसर्वर उपलब्ध नहीं। कृपया पहले सेटिंग्स में कुछ सक्षम करें।",
  ...
  knowledge: {
    help: {
      ...
      chunkSize: "चंक साइज (अक्षरों में, 500~5000)। बड़े चंक अधिक संदर्भ रखते हैं लेकिन ग्रेन्युलैरिटी कम करते हैं।",
      ...
      semanticSegmentation: "सक्षम होने पर, एम्बेडिंग मॉडल का उपयोग करके सिमांटिक बाउंडरी द्वारा इंटेलिजेंटली सेगमेंट करता है, चंकिंग क्वालिटी में सुधार करता है। नोट: इससे प्रोसेसिंग समय बढ़ता है और अतिरिक्त टोकन खर्च होते हैं।",
      raptorLLMModel: "मल्टी-लेवल सारांश उत्पन्न करने के लिए भाषा मॉडल। रिट्रीवल में सुधार के लिए पदानुक्रमित सारांश ट्री बनाता है। नोट: इससे प्रोसेसिंग समय बढ़ता है और अतिरिक्त टोकन खर्च होते हैं।",
    },
    tabs: {
      personal: "व्यक्तिगत",
      team: "टीम",
    ...
    folder: {
      ...
      parentFolderHelp: "नेस्टेड फोल्डर बनाने के लिए एक पैरेंट फोल्डर चुनें। रूट लेवल पर बनाने के लिए खाली छोड़ें।",
    ...
    viewer: {
      ...
      corruptedOrWrongType: "डॉक्यूमेंट दूषित हो सकता है या फाइल प्रकार मेल नहीं खाता (वास्तविक सामग्री {type} प्रारूप से मेल नहीं खाती)। प्रीव्यू नहीं हो सकता। कृपया बाहरी रूप से खोलें।",
  ...
  memory: {
    ...
    deleteConfirmTitle: "हटाने की पुष्टि करें",
    deleteThematicFactConfirm: "क्या आप इस विषय सारांश को हटाना चाहते हैं? यह क्रिया पूर्ववत नहीं की जा सकती।",
    deleteEventStreamConfirm: "क्या आप इस बातचीत लॉग को हटाना चाहते हैं? यह क्रिया पूर्ववत नहीं की जा सकती।",
    updateSuccess: "सफलतापूर्वक अपडेट किया गया",
    updateFailed: "अपडेट करने में विफल",
    deleteSuccess: "सफलतापूर्वक हटाया गया",
    deleteFailed: "हटाने में विफल",
  ...
  channels: {
    ...
    toggle: {
      ...
      enableDesc: "सक्षम होने पर, सिस्टम इस चैनल से कनेक्ट करने और मैसेज प्राप्त करने का प्रयास करेगा।",
  ...
  scheduledTasks: {
    ...
    emptyDescription: "AI वर्कफ़्लो को ऑटोमेट करने के लिए शेड्यूल्ड टास्क बनाएं। टास्क निर्धारित समय पर मैसेज भेज, क्वेरी चला, या कार्रवाई कर सकते हैं।",
