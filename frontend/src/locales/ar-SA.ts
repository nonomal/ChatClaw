export default {
  ...
  channels: {
    ...
    wechat: {
      ...
      qrExpiredHint: "لم يعد رمز QR صالحًا أو انتهت مهلة الانتظار. اضغط على \"تحديث\" في الأسفل للحصول على رمز جديد.",
    },
    whatsapp: {
      emptyTitle: "لم يتم إضافة WhatsApp بعد",
      emptyDesc: "اتصل بـ WhatsApp عبر قناة WhatsApp المدمجة في OpenClaw بمسح رمز QR (WhatsApp Web).",
      addNow: "إضافة الآن",
      configTitle: "إعداد WhatsApp",
      howToConnect: "كيفية الاتصال",
      step1: "بعد الضغط على الزر أدناه، يفعّل التطبيق قناة WhatsApp المدمجة في OpenClaw عند الحاجة.",
      step2: "يشغّل التطبيق بعدها تدفق تسجيل الدخول بمسح QR في الخلفية؛ امسح الرمز بهاتفك باستخدام WhatsApp.",
      step3: "بعد نجاح تسجيل الدخول يمكنك ربط المساعد من هذه الصفحة وإدارة الاتصال؛ يؤدي حذف القناة إلى تسجيل الخروج وإزالة الربط.",
      ...
      qrExpiredHint: "انتهت صلاحية رمز QR أو انتهت مهلة الانتظار. اضغط على \"تحديث\" أدناه للحصول على رمز جديد.",
      ...
      editNotSupported: "يتم ربط WhatsApp عبر مسح الرمز، لذلك لا يمكن تعديله هنا. لتبديل الحساب، احذف هذه القناة ثم أعد إضافتها.",
    },
  },
  scheduledTasks: {
