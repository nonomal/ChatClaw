export default {
  ...
  toolsPage: {
    ...
    smartSidebar: {
      ...
      description: 'الالتصاق بشريط الدردشة الجانبي في WeCom و QQ وغيرها للاستعلام عن الذكاء الاصطناعي في الوقت الفعلي',
    },
    selectionSearch: {
  ...
  settings: {
    ...
    openclawRuntime: {
      ...
      composer: {
        gatewayDisabledHint: 'البوابة غير مُفعّلة',
        gatewayTagError: 'البوابة غير طبيعية',
        gatewayTagStarting: 'البوابة في طور البدء',
        gatewayTagUpgrading: 'Runtime upgrading',
        gatewayTagStop: 'البوابة لا تعمل',
      },
      doctor: {
        command: 'الأمر',
        duration: 'المدة',
        ...
        failed: 'فشل التنفيذ',
        fixed: 'تم الإصلاح',
        noErrors: 'لا توجد أخطاء حتى الآن',
        noOutput: 'لا يوجد مخرجات حتى الآن',
        run: 'تشغيل',
        runAndFix: 'تشغيل وإصلاح',
        running: 'جاري التشغيل...',
        stderr: 'الخطأ القياسي',
        stdout: 'المخرجات القياسية',
        success: 'نجح التنفيذ',
        title: 'تشخيص OpenClaw Doctor',
        workingDir: 'دليل العمل',
        autoTriggered: 'فشل اتصال OpenClaw أكثر من 3 مرات، جاري تشغيل التشخيص والإصلاح التلقائي...',
      },
      gatewayStatusLabel: 'حالة البوابة',
      logs: 'السجلات',
      logsHint: 'سجلات البوابة موجودة في مجلد logs تحت دليل التشغيل (openclaw-gateway.log).',
      pageSubtitle: 'تهيئة معلومات الإعدادات الأساسية مثل البوابة',
      restart: 'إعادة التشغيل',
      restartFailed: 'فشل إعادة تشغيل البوابة',
      restartSuccess: 'تمت إعادة تشغيل البوابة',
      sidebarGatewayLabelSeparator: '：',
      sidebarGatewayPrefix: 'البوابة',
      statusBadge: {
        error: 'error',
        running: 'running',
        starting: 'starting',
      ...
      stopSuccess: 'تم إيقاف البوابة',
      autoStartDisabled: 'تم إغلاق بوابة OpenClaw',
      autoStartEnabled: 'تم فتح بوابة OpenClaw',
      autoStartFailed: 'فشل تبديل حالة البوابة',
      autoStartLabel: 'مفتاح تشغيل البوابة',
      autoStartTooltip: 'انقر لتفعيل أو إيقاف التشغيل التلقائي لبوابة OpenClaw، بعد التفعيل ستبدأ البوابة تلقائيًا عند بدء التطبيق',
      cancelUpgrade: 'إلغاء الترقية',
      continueOrRestartDesc: 'تم اكتشاف ذاكرة تخزين مؤقت للتنزيل لإصدار {version}، يرجى اختيار متابعة الترقية (بدءً من npm install) أو إعادة التنزيل.',
      continueOrRestartTitle: 'تم اكتشاف ذاكرة تخزين مؤقت للترقية موجودة',
      continueUpgrade: 'متابعة الترقية',
      portOccupied: 'المنفذ مشغول',
      portOccupiedHint: 'المنفذ {port} مشغول من قبل العملية {process} (PID: {pid})، يرجى إيقاف هذه العملية أولاً والمحاولة مرة أخرى.',
      portStillOccupiedAfterStop: 'لم يتم تحرير المنفذ {port} بعد إيقاف البوابة',
      portStillOccupiedAfterStopHint: 'يرجى إنهاء العملية التي تشغل المنفذ يدويًا (PID: {pid}).',
      restartUpgrade: 'إعادة الترقية',
      start: 'بدء',
      startFailed: 'فشل بدء البوابة',
      startSuccess: 'بدأت البوابة',
      starting: 'جاري البدء...',
      startSteps: {
        resolvedRuntime: 'تم تحديد بيئة التشغيل: {path}',
        hotfixApplied: 'تم تطبيق {count} ملف(ات) إصلاح عاجل',
        stoppedExisting: 'تم إيقاف العملية الموجودة',
        verifiedInstall: 'تم التحقق من الإصدار المثبت {version}',
        ensuredStateDir: 'تم تهيئة دليل حالة بيئة التشغيل',
        adoptingExisting: 'تم اعتماد البوابة الموجودة (PID: {pid})',
        startedProcess: 'جارٍ بدء عملية البوابة (المنفذ: {port})',
        existingProcessReused: 'تم إعادة استخدام العملية الموجودة (PID: {pid})',
        connecting: 'جارٍ الاتصال بمقبس الويب (المنفذ: {port})',
        autoApproved: 'تمت الموافقة تلقائيًا على إقران الجهاز',
        connected: 'البوابة متصلة',
      },
      upgradeCancelFailed: 'فشل إلغاء الترقية',
      upgradeCancelled: 'تم إلغاء الترقية',
      upgradeDetails: 'التفاصيل',
      upgradeOutputWaiting: 'في انتظار المخرجات...',
    },
    general: {
      ...
      toolchain: {
        ...
        bun: {
          ...
          description: 'يمكّن مساعد الذكاء الاصطناعي من كتابة وتشغيل نصوص JavaScript لإتمام المهام المعقدة.',
        },
        codex: {
          name: 'صندوق رمل آمن',
        ...
        newVersionHint: 'الإصدار الجديد {version}',
        openPathFailed: 'لا يمكن فتح هذا المسار',
        openPathHint: 'فتح الدليل الموجود في مدير الملفات',
        update: 'تحديث',
        updatesAvailableToast: 'تم اكتشاف إصدار جديد لمكونات الامتداد، يمكنك التحديث يدويًا في "الإعدادات > الإعدادات العامة".',
      },
    },
    memory: {
      ...
      enableHint: 'بعد التمكين، سيقوم الذكاء الاصطناعي باستخراج وتذكر تفضيلاتك وعاداتك والحقائق المهمة تلقائيًا أثناء المحادثة.',
      rebuildWarning: 'بعد تعديل نموذج المتجهات أو البُعد، سيتم إعادة بناء جميع بيانات المتجهات للذاكرة الموجودة بشكل غير متزامن.',
    },
    skills: {
      title: 'المهارات',
      ...
      directoryHint: 'ضع مجلدات المهارات التي تم تنزيلها في هذا الدليل، سيقوم مساعد الذكاء الاصطناعي بالتعرف والتحميل تلقائيًا أثناء المحادثة.',
      enableHint: 'بعد التمكين، سيقوم مساعد الذكاء الاصطناعي بتحميل واستخدام المهارات المثبتة تلقائيًا أثناء المحادثة.',
    },
    openclawSkills: {
    ...
    mcp: {
      ...
      enableHint: 'بعد التمكين، سيقوم مساعد الذكاء الاصطناعي بالاتصال تلقائيًا واستخدام خدمات MCP المهيأة أثناء المحادثة.',
    },
    snap: {
      title: 'الإعدادات',
    ...
    chatwiki: {
      ...
      authExpiredPleaseReauth: 'لم يتم الحصول على معلومات تسجيل الدخول للحساب، يرجى إعادة التفويض',
      modelLoginHint: 'يرجى تسجيل الدخول وربط حساب ChatWiki أولاً، ثم سيتم عرض أحدث قائمة لخدمات النموذج هنا.',
  ...
  assistant: {
    ...
    channels: {
      ...
      createDesc: 'انسخ عملية الإضافة من صفحة القناة، سيتم الربط تلقائيًا بالمساعد الحالي بعد الإنشاء.',
    },
    conversation: {
    ...
    errors: {
      ...
      modelNotSupportVision: 'النموذج الحالي لا يدعم التعرف على الصور، يرجى التبديل إلى نموذج متعدد الوسائط يدعم الرؤية',
    },
    toasts: {
    ...
    settings: {
      ...
      workspace: {
        ...
        nativeDesc: 'تنفيذ الأوامر مباشرة على الجهاز المحلي، بدون عزل sandbox. تمتلك الأوامر صلاحيات كاملة للمستخدم الحالي.',
      ...
      advanced: {
        ...
        builtinToolsUnavailable: 'لا يمكن قراءة دليل الأدوات المدمجة في OpenClaw حاليًا، لا يزال بإمكانك إدخال اسم الأداة يدويًا.',
        toolsHint: 'الأولوية للحظر أعلى من السماح. يمكن الاستمرار في إدخال أدوات البرنامج المساعد أو الأدوات المخصصة يدويًا، اضغط Enter للتأكيد بعد الإدخال.',
      },
    },
    workspaceDrawer: {
      title: 'مساحة العمل',
  ...
  knowledge: {
    help: {
      ...
      batchMaxChunks: 'مرحلة تعلم التضمين، الحد الأقصى لعدد المقاطع في كل طلب تحويل متجهي. نطاق القيمة: 1~20.',
      chunkSize: 'حجم المقطع (عدد الأحرف، 500~5000). كلما كان المقطع أكبر، كان السياق أكثر اكتمالًا، لكن دقة الاستدعاء ستكون أخشن.',
      raptorLLMModel: 'نموذج اللغة المستخدم لإنشاء الملخصات الهرمية؛ إذا لم يتم الاختيار فلن يتم تفعيل هذه القدرة.',
    },
    tabs: {
      personal: 'شخصي',
      team: 'فريق',
    ...
    content: {
      ...
      relearn: {
        ...
        successBatch: 'بدأت إعادة التعلم لـ {count} مستندات',
        failed: 'فشل إعادة التعلم',
      },
      delete: {
        title: 'تأكيد الحذف',
        desc: 'هل أنت متأكد من حذف ',
        descBatch: 'حذف {count} مستندات محددة؟ لا يمكن التراجع عن هذا الإجراء.',
        cancel: 'إلغاء',
        confirm: 'حذف',
        success: 'تم الحذف',
        successBatch: 'تم حذف {count} مستندات',
        failed: 'فشل الحذف',
      },
      moveToFolder: {
        title: 'نقل إلى مجلد',
        ...
        successBatch: 'تم نقل {count} مستندات بنجاح',
        failed: 'فشل النقل',
      },
  ...
  channels: {
    ...
    toggle: {
      ...
      dingtalkPluginNotReady: 'ملحق موصل DingTalk لا يزال قيد التثبيت أو غير جاهز، يرجى المحاولة لاحقًا.',
      disableDesc: 'بعد الإغلاق، سيتم قطع الاتصال بهذه القناة، لن يستقبل النظام رسائلها بعد الآن.',
    },
    status: {
      online: 'متصل',
      error: 'خطأ',
    ...
    provisioning: {
      ...
      toastDescription: 'جاري إنشاء القناة والبوابة أو مزامنتها، سيتم تحديث حالة الاتصال تلقائيًا، يرجى الانتظار.',
      toastDescriptionWithAgent: 'جاري إنشاء القناة والمساعد أو البوابة أو مزامنتها، يرجى الانتظار.',
    },
    wecom: {
      emptyTitle: 'لم تتم إضافة WeCom بعد',
      emptyDesc: 'الاتصال بـ WeCom عبر مسح رمز QR باستخدام المكون الإضافي الرسمي OpenClaw من Tencent، مع دعم الاتصال بالبوتات الموجودة.',
    },
    wechat: {
      ...
      createAssistantHint: 'عند إنشاء مساعد جديد، تحتاج إلى ملء الاسم والمعلومات الأخرى يدويًا؛ بعد الإنشاء الناجح سيتم الربط تلقائيًا وتحديث الاتصال.',
      emptyDesc: 'الاتصال بـ WeChat الشخصي عبر مسح رمز QR باستخدام المكون الإضافي الرسمي OpenClaw من Tencent، والبدء في استقبال رسائل WeChat ومعالجتها.',
      missingChannelId: 'تعذر الحصول على معلومات القناة، يرجى الإغلاق وتحديث قائمة القنوات والمحاولة مرة أخرى.',
      missingChannelIdHint: 'تعذر الحصول على معرف القناة، يرجى إغلاق هذه النافذة وربط المساعد يدويًا في قائمة القنوات.',
      pluginInstallTryLater: 'المكون الإضافي WeChat الرسمي قيد التثبيت أو التمكين في الخلفية، يرجى المحاولة لاحقًا.',
      qrExpiredHint: 'انتهت صلاحية رمز QR أو انتهت مهلة الانتظار، يرجى النقر على "تحديث" أدناه للحصول على واحد جديد.',
      step1: 'انقر لإنشاء رمز QR، سيتم تثبيت وتمكين المكون الإضافي WeChat الرسمي في OpenClaw',
      tipsIntro: 'الاتصال بـ WeChat الشخصي عبر مسح رمز QR باستخدام المكون الإضافي الرسمي OpenClaw من Tencent',
    },
    whatsapp: {
      emptyTitle: 'لم يتم إضافة WhatsApp بعد',
      addNow: 'إضافة الآن',
      configTitle: 'إعداد WhatsApp',
      howToConnect: 'كيفية الاتصال',
      configStepsLink: 'الوثائق الرسمية',
      generateQRCode: 'إنشاء رمز QR',
      generating: 'جارٍ الإنشاء…',
      scanHint: 'امسح رمز QR أدناه باستخدام WhatsApp لإكمال التفويض',
      waitingForScan: 'في انتظار المسح…',
      refresh: 'تحديث',
      qrExpired: 'انتهت صلاحية رمز QR',
      loginSuccess: 'تم الاتصال بـ WhatsApp',
      pluginInstallTryLater: 'قناة WhatsApp قيد التفعيل أو غير جاهزة بعد. يرجى المحاولة لاحقًا.',
      channelNotFound: 'لم يتم العثور على القناة المقابلة. حدّث وحاول مرة أخرى.',
      emptyDesc: 'الاتصال بـ WhatsApp عبر مسح رمز QR باستخدام قناة WhatsApp المدمجة في OpenClaw (WhatsApp Web).',
      qrExpiredHint: 'انتهت صلاحية رمز QR أو انتهت مهلة الانتظار، يرجى النقر على "تحديث" أدناه للحصول على واحد جديد.',
      step1: 'بعد النقر على الزر أدناه، سيقوم التطبيق أولاً بتمكين قناة WhatsApp المدمجة في OpenClaw (إذا لم تكن ممكنة بعد).',
      step2: 'ثم يقوم التطبيق بتشغيل عملية تسجيل الدخول بمسح رمز QR في الخلفية؛ يرجى مسح رمز QR بتطبيق WhatsApp على الهاتف.',
      step3: 'بعد نجاح تسجيل الدخول، يمكنك ربط المساعد في هذه الصفحة وإدارة حالة الاتصال؛ سيؤدي حذف القناة إلى تسجيل الخروج ومسح الربط.',
    },
    backToOverview: 'العودة إلى نظرة عامة على القناة',
    panel: {
      add: 'إضافة',
    },
    platformBlurbs: {
      default: 'الاتصال بهذه المنصة لاستقبال وإرسال الرسائل.',
      dingtalk: 'الاتصال ببوت DingTalk المؤسسي، وتحقيق تفاعل مستقر للمحادثة الجماعية والرسائل الخاصة عبر وضع Stream.',
      feishu: 'الاتصال بتطبيق Feishu المؤسسي لتحقيق التفاعل التلقائي للمحادثة الجماعية والرسائل الخاصة.',
      qq: 'الاتصال بالبوت الرسمي QQ، وتغطية جميع سيناريوهات التفاعل للمحادثة الجماعية والقناة والرسائل الخاصة.',
      wechat: 'الاتصال بـ WeChat عبر مسح رمز QR، يتصل WeChat بالبوت للدردشة مباشرة.',
      wecom: 'استخدام معرف البوت وSecret للاتصال بالبوت الرسمي لـ WeCom.',
      whatsapp: 'الاتصال بـ WhatsApp عبر مسح رمز QR، والبدء بسرعة في التواصل التجاري العالمي.',
    },
    platformCard: {
      connect: 'اتصال',
    },
    row: {
      boundToAgent: 'مرتبط بـ {name}',
    },
    supported: {
  ...
  scheduledTasks: {
    ...
    dialog: {
      ...
      promptPlaceholder: 'ماذا يجب على الذكاء الاصطناعي أن يفعل؟ مثال: أرسل لي ملخص أخبار وحالة الطقس اليوم',
    },
    operationLog: {
      title: 'سجل العمليات',
    ...
    form: {
      ...
      yearOption: '{year}',
      monthOption: '{month}',
      expiredHint: 'انتهت صلاحية هذه المهمة ولن يتم تنفيذها بعد الآن. لاستعادة التنفيذ، يرجى تغيير وقت الانتهاء إلى المستقبل.',
    },
  ...
  openclawGateway: {
    banner: {
      ...
      channels: 'البوابة لا تعمل، لا يمكن إدارة قنوات الرسائل عند تعطيل البوابة',
      scheduledTasks: 'البوابة لا تعمل، لا يمكن إدارة المهام المجدولة عند تعطيل البوابة',
      notInstalled: 'لم يتم اكتشاف بيئة تشغيل OpenClaw. قم بتثبيتها من「الإعدادات → عام」أو「مدير OpenClaw」.',
    },
  },
  openclawCron: {
    title: 'المهام المجدولة',
    ...
    history: {
      conversationPreparing: 'جاري تحضير سجل المحادثة، يرجى الانتظار...',
      delivery: 'حالة التسليم',
      deliveryStatus: {
        delivered: 'تم التسليم',
        failed: 'فشل التسليم',
        not_delivered: 'غير مُسلّم',
        pending: 'في انتظار التسليم',
        success: 'تم التسليم بنجاح',
      },
      detailErrorReason: 'سبب الفشل',
      detailLoadFailed: 'فشل تحميل تفاصيل التشغيل',
      detailLoadFailedDescription: 'تعذر الحصول على تفاصيل المحادثة لهذا التشغيل، يرجى التحقق من حالة تشغيل OpenClaw والمحاولة مرة أخرى.',
      detailLoadFailedReason: 'يرجى التأكد من تشغيل OpenClaw Gateway والمحاولة لاحقًا.',
      detailLoading: 'جاري تحميل تفاصيل المحادثة...',
      duration: 'المدة',
      empty: 'لا يوجد سجل تشغيل حتى الآن',
      error: 'معلومات الخطأ',
      model: 'النموذج',
      provider: 'المزود',
      retryLoadDetail: 'إعادة تحميل المحاولة',
      runAt: 'وقت التشغيل',
      selectRun: 'يرجى تحديد سجل تشغيل',
      summary: 'ملخص التشغيل',
      title: 'سجل التشغيل',
      waitingTriggeredRun: 'تم تفعيل المهمة، في انتظار كتابة OpenClaw لسجل تشغيل جديد...',
    },
    runNowQueued: 'بدأت المهمة في التنفيذ، يرجى التحقق من النتائج في السجل لاحقًا',
    schedule: {
      atPrefix: 'الوقت المحدد',
      daily: 'كل يوم في {time}',
      everyPrefix: 'كل',
      monthly: 'يوم {day} من كل شهر في {time}',
      weekdays: {
        friday: 'الجمعة',
        monday: 'الاثنين',
        saturday: 'السبت',
