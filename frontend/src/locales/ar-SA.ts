export default {
  ...
  channels: {
    ...
    wechat: {
      ...
      step4: '3. استخدم WeChat لمسح رمز الاستجابة السريعة أدناه ثم أكّد الاتصال على هاتفك',
      step5: '4. بعد نجاح الاتصال، ستظهر محادثة جديدة باسم «WeChat ClawBot» تلقائيًا داخل WeChat. ويمكنك لاحقًا تكرار مسار المسح لإضافة المزيد من حسابات WeChat أو إعادة ربط حساب موجود.',
