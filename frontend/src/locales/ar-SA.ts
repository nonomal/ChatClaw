export default {
  ...
  settings: {
    ...
    general: {
      ...
      toolchain: {
        ...
        bun: {
          ...
          description:
            'تمكين مساعد الذكاء الاصطناعي من كتابة وتشغيل نصوص JavaScript للمهام المعقدة.',
        },
        codex: {
          name: 'صندوق رمل آمن',
    ...
    memory: {
      ...
      enableHint:
        'عند التفعيل، سيستخرج الذكاء الاصطناعي ويتذكر تفضيلاتك وعاداتك والحقائق المهمة تلقائيًا.',
      ...
      rebuildWarning:
        'بعد تغيير نموذج المتجهات أو البُعد، سيتم إعادة بناء جميع بيانات متجهات الذاكرة الموجودة بشكل غير متزامن.',
      ...
      confirmRebuildDesc:
        'لقد قمت بتغيير نموذج المتجهات أو البُعد، مما يتطلب إعادة حساب بيانات المتجهات لجميع الذكريات الموجودة. قد تستغرق هذه العملية بعض الوقت. هل تريد المتابعة؟',
    },
    skills: {
      title: 'المهارات',
      enable: 'تفعيل المهارات',
      enableHint:
        'عند التفعيل، سيقوم مساعد الذكاء الاصطناعي بتحميل واستخدام المهارات المثبتة تلقائيًا خلال المحادثات.',
      pageDesc: 'تصفح وإدارة قدرات الذكاء الاصطناعي',
      directory: 'دليل تحميل المهارات',
      directoryHint:
        'ضع مجلدات المهارات التي قمت بتنزيلها في هذا الدليل، وسيتم اكتشافها وتحميلها تلقائيًا.',
      tabInstalled: 'مثبت',
      tabMarket: 'السوق',
      filterAll: 'الكل',
      filterBuiltin: 'مدمج',
      ...
      noLocalSkillsHint:
        'أنشئ مجلدًا في دليل المهارات، وأنشئ ملف SKILL.md باتباع مواصفات المهارة لإنشاء مهارة محلية',
      addLocalSkill: 'إضافة',
      addLocalSkillHint:
        'أنشئ مجلدًا في دليل المهارات، وأنشئ ملف SKILL.md باتباع مواصفات المهارة لإنشاء مهارة محلية',
    ...
    chatwiki: {
      ...
      unbindConfirmDesc:
        'بعد إلغاء الربط، لن تتمكن من استخدام تطبيقات وقواعد المعرفة في ChatWiki. هل أنت متأكد؟',
  ...
  assistant: {
    ...
    errors: {
      ...
      modelNotSupportVision:
        'النموذج الحالي لا يدعم التعرف على الصور. يرجى التبديل إلى نموذج رؤية متعدد الوسائط',
    ...
    settings: {
      ...
      workspace: {
        ...
        codexDesc:
          'تنفيذ الأوامر في صندوق رمل على مستوى نظام التشغيل مقدمة من OpenAI Codex CLI. يمكن للأوامر فقط كتابة الملفات ضمن دليل العمل؛ باقي نظام الملفات للقراءة فقط.',
        codexNotInstalled:
          'صندوق الرمل غير مثبت بعد. وضع الصندوق الرملي غير متاح مؤقتًا وسيعود للتنفيذ الأصلي. يمكنك تثبيته في الإعدادات → العامة → الملحقات.',
        nativeDesc:
          'تنفيذ الأوامر مباشرة على الجهاز المضيف دون عزل صندوق الرمل. الأوامر لديها صلاحيات كاملة للمستخدم الحالي.',
        networkAccess: 'السماح بالوصول إلى الشبكة',
        networkAccessDesc:
          'عند التفعيل، يمكن للأوامر داخل الصندوق الرملي الوصول إلى الشبكة (مثل npm install وpip install). عند التعطيل، لا يمكن للأوامر الوصول إلى الشبكة، وهو أكثر أمانًا.',
        workDir: 'دليل العمل',
        workDirDesc:
          'سيتم حفظ جميع مخرجات وملفات الجلسة في هذا الدليل. تنشئ كل محادثة مجلدًا فرعيًا ضمن sessions/.',
        workDirHint:
  ...
  knowledge: {
    help: {
      ...
      chunkSize:
        'حجم الشريحة (بالأحرف، 500~5000). الشريحة الأكبر تحافظ على سياق أكثر لكن تقلل الدقة.',
      ...
      semanticSegmentation:
        'عند التفعيل، يستخدم نموذج التضمين للتجزئة الذكية حسب الحدود الدلالية، مما يحسن جودة التجزئة. ملاحظة: هذا يزيد من وقت الاستهلاك ويزيد من استهلكTokens.',
      raptorLLMModel:
        'نموذج اللغة لإنشاء ملخصات متعددة المستويات. يبني شجرة ملخص هرمية لتحسين الاسترجاع. ملاحظة: هذا يزيد من وقت الاستهلاك ويزيد من استهلكTokens.',
    },
    tabs: {
      personal: 'شخصي',
      team: 'فريق',
    ...
    viewer: {
      ...
      corruptedOrWrongType:
        'قد تكون الوثيقة تالفة أو نوع الملف غير متطابق (المحتوى الفعلي لا يتطابق مع تنسيق {type}). لا يمكن المعاينة. يرجى الفتح خارجيًا.',
  ...
  memory: {
    ...
    deleteThematicFactConfirm:
      'هل أنت متأكد من حذف ملخص الموضوع هذا؟ لا يمكن التراجع عن هذا الإجراء.',
  ...
  channels: {
    ...
    toggle: {
      ...
      enableDesc:
        'عند التمكين، ستAttempt to establish a connection and begin receiving messages through this channel.',
      disableDesc:
        'عند التعطيل، ستterminate the connection and stop processing messages from this channel.',
    },
    status: {
      online: 'متصل',
      error: 'خطأ',
  ...
  scheduledTasks: {
    ...
    emptyDescription:
      'أنشئ مهام مجدولة لأتمتة مهام سير عمل الذكاء الاصطناعي. يمكن للمهام إرسال رسائل أو تشغيل استعلامات أو تنفيذ إجراءات في أوقات محددة.',
