export default {
  ...
  "settings": {
    ...
    "openclawSkills": {
      ...
      "refreshCta": "重新整理",
      "addSkillCta": "新增技能",
      "pageDesc": "优先通过已连接的 OpenClaw Gateway 调用 skills.status；离线时按 OpenClaw 文档扫描状态目录（managed / workspace / bundled / extraDirs）。",
      "filterAll": "全部",
      "filterBuiltin": "內建",
      "filterInstalled": "已安裝",
      ...
      "noSkillsHint": "请确认 Gateway 已连接；离线时请按 OpenClaw 文档放置技能（状态目录下 skills、各 workspace-*/skills、bundled 包、openclaw.json 的 skills.load.extraDirs）。",
      ...
      "scopeLabel": "范围",
      "agentBinding": "所属代理",
      "gatewayOfflineHint": "Gateway 未连接时改为扫描 OpenClaw 约定目录；连接后将优先使用 skills.status。",
      "backToList": "返回列表",
      ...
      "eligibleUnknown": "未知",
      "gateHintLabel": "网关提示",
      "previewNoLocalPath": "当前项仅来自 Gateway，本地无对应目录时无法预览文件；连接正常且磁盘存在同名技能包时可自动关联路径。",
      "add": {
        "title": "新增",
        "createViaChatTitle": "通过对话创建",
        "createViaChatDesc": "描述你的需求，AI 帮你生成 OpenClaw 技能",
        "choosePackageTitle": "选择技能包",
        "choosePackageDesc": "打开技能目录，将技能包放到对应位置",
        "createViaChatPrompt": "请帮我创建一个 OpenClaw skill。先问我需要什么功能，然后根据需求给出 SKILL.md（含 frontmatter）和必要的文件结构与示例代码。最后告诉我把技能目录放到 workspace-main/skills 下即可生效。"
      }
    },
    "mcp": {
      "title": "MCP",
  ...
  "assistant": {
    ...
    "fields": {
      ...
      "identityEmojiHint": "僅支持 Emoji 表情符號",
      "identityTheme": "身份主題",
    ...
    "settings": {
      ...
      "advanced": {
        ...
        "toolsHint": "控制助手可使用的工具範圍，輸入後按 Enter 確認",
        "heartbeat": "心跳間隔",
        "heartbeat_off": "關閉",
        "heartbeat_custom": "自訂",
  ...
  "channels": {
    ...
    "wecomAdd": {
      "title": "配置企微",
      "subtitle": "通过腾讯官方 OpenClaw 插件扫码连接企业微信",
      "howTitle": "如何連接",
      "tipsIntro": "透過騰訊官方 OpenClaw 外掛掃碼連接企業微信",
      "stepsLabel": "步驟：",
      "step1": "點選產生 QR Code，會在 OpenClaw 中安裝並啟用官方企微外掛",
      "step2": "使用企微掃描下方 QR Code，並在手機上確認連接",
      "tipsOrManual": "或填入已建立的機器人資訊接入",
      "scanHint": "使用企微掃描下方 QR Code，並在手機上確認連接",
      "manualEntry": "已有机器人接入",
      "generateQr": "生成二维码",
      "refreshQr": "刷新",
      "generating": "生成中…",
      ...
      "missingCredentials": "授权成功但未获取到 Bot 信息",
      "registerFailed": "注册频道失败",
      "authFailed": "授权失败或已过期，请刷新重试",
      "defaultName": "企微机器人",
      "openScanAdd": "扫码添加企业微信",
      "qrExpired": "QR Code 已過期（有效期限 5 分鐘）",
      "qrExpiredHint": "請點選「重新整理」以產生新的 QR Code 後再掃描。"
    },
    "platforms": {
      "dingtalk": "DingTalk",
      "feishu": "Feishu",
