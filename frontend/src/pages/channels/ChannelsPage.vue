...
/** When overview tab is active, group configured channels by platform for the list panel (Figma). */
...
function handlePlatformCardConnect(platform: PlatformMeta) {
...
function handleAddForPlatform(platform: PlatformMeta) {
  handleSelectPlatform(platform)
}
                    ...
                    <div
                      ...
                      :class="{
                        ...
                        'border-border text-muted-foreground':
                          channel.status !== 'online' && channel.status !== 'error',
                      }"
                    >
                      <span
                        class="size-2 shrink-0 rounded-full"
                        :class="{
                          'bg-green-600': channel.status === 'online',
