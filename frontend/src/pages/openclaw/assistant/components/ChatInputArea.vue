...
/** OpenClaw: team knowledge tab is disabled until the feature ships; always open on personal. */
...
<template>
  <div
    :class="
      cn('flex px-6', showAssistantEmptyState ? 'flex-1 items-center justify-center' : 'pb-4')
    "
  >
    <div
      :class="
        cn('flex w-full flex-col items-center gap-10', showAssistantEmptyState && '-translate-y-10')
      "
    >
      <div v-if="showAssistantEmptyState" class="flex items-center gap-3">
        <img :src="openclawIconUrl" class="h-[48px] w-[48px]" alt="openclaw" />
        <div class="text-[36px] font-semibold leading-none text-foreground">OpenClaw</div>
      </div>
      ...
      <div
        ...
        @drop="handleDrop"
      >
        <OpenClawGatewayComposerBanner v-if="blocksComposer" :visual-status="visualStatus" />
                  ...
                  <TooltipTrigger as-child>
                    <div class="min-w-0">
                      <Select
                        ...
                        @update:model-value="
                          (v: any) => v && emit('update:activeAgentId', Number(v))
                        "
                      >
                        <SelectTrigger
                                  ...
                                  <template v-if="g.type === 'llm'">
                                    ...
                                    >
                                      <div class="flex items-center gap-2">
                                        ...
                                        <template
                                          v-if="m.capabilities && m.capabilities.length > 0"
                                        >
                                          <span
                        ...
                        <SelectPortal>
                          ...
                          >
                            <div class="mb-1 flex items-center justify-between gap-1 px-0.5">
                              ...
                              <Tooltip>
                                <TooltipTrigger as-child>
                                  <span class="inline-flex cursor-not-allowed rounded-[6px]">
                                    <button
                                      type="button"
                                      disabled
