...
var BuiltinModels = []BuiltinModelConfig{
	...
	// OpenAI
	{ProviderID: "openai", ModelID: "gpt-5.2", Name: "GPT-5.2", Type: "llm", SortOrder: 100, Capabilities: []string{"text", "image", "audio", "video", "file"}},
	{ProviderID: "openai", ModelID: "gpt-5.1", Name: "GPT-5.1", Type: "llm", SortOrder: 101, Capabilities: []string{"text", "image", "audio", "video", "file"}},
	{ProviderID: "openai", ModelID: "gpt-5", Name: "GPT-5", Type: "llm", SortOrder: 102, Capabilities: []string{"text", "image", "audio", "video", "file"}},
	{ProviderID: "openai", ModelID: "gpt-5-mini", Name: "GPT-5 mini", Type: "llm", SortOrder: 103, Capabilities: []string{"text", "image", "audio", "video", "file"}},
	{ProviderID: "openai", ModelID: "gpt-5.2-nano", Name: "GPT-5.2 nano", Type: "llm", SortOrder: 104, Capabilities: []string{"text", "image", "audio", "video", "file"}},
	{ProviderID: "openai", ModelID: "gpt-5.2-pro", Name: "GPT-5.2 pro", Type: "llm", SortOrder: 105, Capabilities: []string{"text", "image", "audio", "video", "file"}},
	...
	// Anthropic
	{ProviderID: "anthropic", ModelID: "claude-opus-4-6", Name: "Claude Opus 4.6", Type: "llm", SortOrder: 100, Capabilities: []string{"text", "image", "file"}},
	{ProviderID: "anthropic", ModelID: "claude-sonnet-4-5-20250929", Name: "Claude Sonnet 4.5", Type: "llm", SortOrder: 101, Capabilities: []string{"text", "image", "file"}},
	{ProviderID: "anthropic", ModelID: "claude-haiku-4-5-20251001", Name: "Claude Haiku 4.5", Type: "llm", SortOrder: 102, Capabilities: []string{"text", "image", "file"}},
	...
	// DeepSeek
	{ProviderID: "deepseek", ModelID: "deepseek-chat", Name: "DeepSeek V3", Type: "llm", SortOrder: 100, Capabilities: []string{"text", "image"}},
	...
	{ProviderID: "zhipu", ModelID: "glm-4.6", Name: "glm-4.6", Type: "llm", SortOrder: 103, Capabilities: []string{"text", "image"}},
	{ProviderID: "zhipu", ModelID: "glm-4.5-air", Name: "glm-4.5-air", Type: "llm", SortOrder: 104, Capabilities: []string{"text", "image"}},
	{ProviderID: "zhipu", ModelID: "glm-4.5-airx", Name: "glm-4.5-airx", Type: "llm", SortOrder: 105, Capabilities: []string{"text", "image"}},
	{ProviderID: "zhipu", ModelID: "glm-4.5-flash", Name: "glm-4.5-flash", Type: "llm", SortOrder: 106, Capabilities: []string{"text", "image"}},
	{ProviderID: "zhipu", ModelID: "glm-4-flash-250414", Name: "glm-4-flash-250414", Type: "llm", SortOrder: 107, Capabilities: []string{"text", "image"}},
	{ProviderID: "zhipu", ModelID: "glm-4-flashx-250414", Name: "glm-4-flashx-250414", Type: "llm", SortOrder: 108, Capabilities: []string{"text", "image"}},
	...
	{ProviderID: "baidu", ModelID: "ernie-4.5-turbo-latest", Name: "ERNIE 4.5 Turbo", Type: "llm", SortOrder: 101, Capabilities: []string{"text", "image"}},
