...
### مساعد الدردشة AI
اسأل مساعد الذكاء الاصطناعي أي سؤال، وسيبحث ذكيًا في قاعدة معرفتك لإنشاء إجابة ذات صلة.
![](../../images/previews/en/image1.png)

### التبديل بين الوضعين للتعامل الفعال مع المهام
يتكيف وضع الدردشة مع السيناريوهات المتعددة للأسئلة والأجوبة والاستدلال؛ ويقترن وضع المهام بسوق مهارات مدمج، مما يمكّن وكلاء الذكاء الاصطناعي من تفكيك المهام المتعددة الخطوات وتقدمها بشكل مستقل لتحسين الكفاءة.
...
### مدير المهارات
استخدم أمرًا ليقوم المساعد بمساعدتك في البحث عن الميزات المثبتة على جهازك أو تثبيت ملحقات جديدة. سوق المهارات — تصفح وثبّت المهارات بحرية.
![](../../images/previews/en/image4.png)

### الذاكرة: تفاعل أوضح وأذكى
تفعيل المحادثات السياقية والمساعدة الشخصية. التعلم المستمر والتطور — يشعر المساعد كشريك متنامٍ يقدم خدمة أكثر دقة وأذكى.
![](../../images/previews/en/image5.png)

### تجربة النموذج المجانية — قاعدة معرفات الفريق المشتركة
الترخيص بنقرة واحدة للاتصال بـ ChatWiki، ومزامنة رصيد حساب ChatWiki، ودعم النماذج المخصصة. نماذج لغوية كبيرة محلية ودولية عالية الجودة مدمجة بما في ذلك Ollama وGoogle Gemini وOpenAI — استخدم نموذج الذكاء الاصطناعي المفضل لديك للعمل اليومي أو السيناريوهات المهنية.
![](../../images/previews/en/image6.png)

### قاعدة المعرفة | تخزين متجه المستندات
قم بتحميل المستندات (TXT وPDF وWord وExcel وCSV وHTML وMarkdown). يحلل النظام ويفصل ويحوّل تلقائيًا إلى تضمينات متجهة، ويخزنها في قاعدة معارف خاصة للاسترجاع الدقيق والاستفادة من خلال نماذج الذكاء الاصطناعي.
![](../../images/previews/en/image7.png)

### تكامل قنوات IM الغنية
من خلال دمج حزم SDK التي يوفرها مزودو خدمات المراسلة الفورية (Feishu وWeCom وQQ وDingTalk وWeChat وWhatsApp وغيرها)، يمكنك تنفيذ قدرات اتصال IM كاملة داخل التطبيق بسرعة، بما في ذلك إنشاء القنوات وإدارة المستخدمين وإرسال واستقبال الرسائل.
![](../../images/previews/en/image8.png)

### المهام المجدولة — تنفيذ الأوامر تلقائيًا
دع المساعد ينفذ تلقائيًا عمليات محددة في أوقات أو فترات محددة مسبقًا، مثل تقديم تذكيرات في الوقت المناسب، وتنفيذ العمل الدوري، وتنفيذ مهام الصيانة على مستوى النظام.
![](../../images/previews/en/image9.png)

### تحديد النص للسؤال والجواب الفوري
حدد أي نص على الشاشة وسيتم نسخه تلقائيًا في مربع السؤال العائم. انقر مرة واحدة لإرساله إلى مساعد الذكاء الاصطناعي للحصول على إجابة فورية.
![](../../images/previews/en/image10.png)

### الشريط الجانبي الذكي
مساعد ذكي يمكن إلصاقه بجانب نوافذ التطبيقات الأخرى. قم بالتبديل بسرعة بين مساعدي الذكاء الاصطناعي المُكوَّنين بشكل مختلف لطرح الأسئلة. يولد الروبوت إجابات بناءً على قاعدة معارفك المرتبطة، ويدعم إرسال الردود بنقرة واحدة في محادثاتك.
![](../../images/previews/en/image11.png)

### سؤال واحد، إجابات متعددة: قارن بسهولة
لا حاجة لتكرار الأسئلة. استشر عدة "خبراء في الذكاء الاصطناعي" في وقت واحد واعرض إجاباتهم جنبًا إلى جنب في نفس الواجهة. سهولة المقارنة ومساعدتك على الوصول إلى أفضل استنتاج.
![](../../images/previews/en/image12.png)

### كرة الإطلاق بنقرة واحدة
انقر على الكرة العائمة على سطح المكتب لإيقاظ نافذة التطبيق الرئيسية ChatClaw أو فتحها فورًا.
