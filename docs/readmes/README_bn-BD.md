...
### দক্ষ কাজ সামলানোর জন্য ডুয়াল-মোড সুইচিং
চ্যাট মোড বহু-পরিস্থিতি প্রশ্নোত্তর ও যুক্তিতে অভিযোজিত; টাস্ক মোড একটি বিল্ট-ইন স্কিল মার্কেটের সাথে জুড়ে, AI এজেন্টদের স্বায়ত্তশাসিতভাবে বহু-পদক্ষেপ টাস্ক বিশ্লেষণ ও অগ্রগতি করতে সক্ষম করে দক্ষতা উন্নতির জন্য।
![](../../images/previews/en/image2.png)

### PPT দ্রুত তৈরি
স্মার্ট অ্যাসিস্টেন্টকে একটি বাক্যের কমান্ড পাঠান এবং স্বয়ংক্রিয়ভাবে একটি PowerPoint প্রেজেন্টেশন তৈরি ও জেনারেট করুন।
![](../../images/previews/en/image3.png)

### স্কিল ম্যানেজার
একটি কমান্ড ব্যবহার করে অ্যাসিস্টেন্টকে আপনার কম্পিউটারে ইনস্টল করা ফিচার খুঁজে বের করতে বা নতুন এক্সটেনশন প্লাগইন ইনস্টল করতে সাহায্য করুন। স্কিল মার্কেট — স্বাধীনভাবে স্কিল ব্রাউজ ও ইনস্টল করুন।
![](../../images/previews/en/image4.png)

### মেমরি: আরও প্রাকৃতিক, আরও স্মার্ট ইন্টারঅ্যাকশন
প্রাসঙ্গিক কথোপকথন ও ব্যক্তিগত সহায়তা সক্ষম করুন। ক্রমাগত শিক্ষা ও বিবর্তন — অ্যাসিস্টেন্ট একটি বর্ধনশীল অংশীদারের মতো অনুভব করে যা ক্রমশ অধিকতর বিচক্ষণ ও বুদ্ধিমান পরিষেবা প্রদান করে।
![](../../images/previews/en/image5.png)

### ফ্রি মডেল ট্রায়াল — শেয়ার্ড টিম নলেজ বেস
ChatWiki-তে সংযোগের জন্য ওয়ান-ক্লিক অনুমোদন, ChatWiki অ্যাকাউন্ট ক্রেডিট সিঙ্ক, এবং কাস্টম মডেল সমর্থন। Ollama, Google Gemini, OpenAI সহ উচ্চ-মানের অভ্যন্তরীণ ও আন্তর্জাতিক LLMs বিল্ট-ইন — দৈনন্দিন অফিসের কাজ বা পেশাদার পরিস্থিতিতে আপনার পছন্দের AI মডেল ব্যবহার করুন।
![](../../images/previews/en/image6.png)

### নলেজ বেস | ডকুমেন্ট ভেক্টরাইজেশন স্টোরেজ
আপনার ডকুমেন্ট আপলোড করুন (TXT, PDF, Word, Excel, CSV, HTML, Markdown)। সিস্টেম স্বয়ংক্রিয়ভাবে পার্স, স্প্লিট এবং ভেক্টর এম্বেডিংয়ে রূপান্তর করে, আপনার প্রাইভেট নলেজ বেসে সংরক্ষণ করে AI মডেল দ্বারা সুনির্দিষ্ট রিট্রিভাল ও ব্যবহারের জন্য।
![](../../images/previews/en/image7.png)

### রিচ IM চ্যানেল ইন্টিগ্রেশন
ইনস্ট্যান্ট মেসেজিং সার্ভিস প্রোভাইডার (Feishu, WeCom, QQ, DingTalk, WeChat, WhatsApp এবং আরও) দ্বারা প্রদত্ত SDK ইন্টিগ্রেট করে, অ্যাপের মধ্যে দ্রুত সম্পূর্ণ IM যোগাযোগ ক্ষমতা বাস্তবায়ন করুন, যার মধ্যে চ্যানেল তৈরি, ইউজার ম্যানেজমেন্ট এবং মেসেজ প্রেরণ ও গ্রহণ অন্তর্ভুক্ত।
![](../../images/previews/en/image8.png)

### শিডিউলড টাস্ক — স্বয়ংক্রিয় কমান্ড এক্সিকিউশন
অ্যাসিস্টেন্টকে প্রিসেট সময় বা ব্যবধানে নির্দিষ্ট অপারেশন স্বয়ংক্রিয়ভাবে কার্যকর করতে দিন, যেমন সময়মতো রিমাইন্ডার প্রদান, পুনরাবৃত্ত কাজ কার্যকর করা, এবং সিস্টেম-লেভেল রক্ষণাবেক্ষণ টাস্ক সম্পাদন।
![](../../images/previews/en/image9.png)

### ইনস্ট্যান্ট Q&A-এর জন্য টেক্সট সিলেকশন
স্ক্রিনে যেকোনো টেক্সট সিলেক্ট করুন এবং এটি স্বয়ংক্রিয়ভাবে একটি ফ্লোটিং কুইক-আস্ক বক্সে কপি হয়ে যাবে। AI অ্যাসিস্টেন্টে এক ক্লিকে পাঠান, তাৎক্ষণিক উত্তর পান।
![](../../images/previews/en/image10.png)

### স্মার্ট সাইডবার
অন্যান্য অ্যাপ্লিকেশন উইন্ডোর পাশে স্ন্যাপ করা যায় এমন একটি স্মার্ট অ্যাসিস্টেন্ট। প্রশ্ন করতে বিভিন্ন কনফিগার করা AI অ্যাসিস্টেন্টের মধ্যে দ্রুত সুইচ করুন। রোবট আপনার সংযুক্ত নলেজ বেসের ভিত্তিতে উত্তর তৈরি করে এবং আপনার কথোপকথনে রিপ্লাই ওয়ান-ক্লিকে পাঠানো সমর্থন করে।
![](../../images/previews/en/image11.png)

### এক প্রশ্ন, একাধিক উত্তর: সহজে তুলনা করুন
প্রশ্ন পুনরাবৃত্তির প্রয়োজন নেই। একই সাথে একাধিক 'AI বিশেষজ্ঞের' কাছে পরামর্শ নিন এবং তাদের উত্তর একই ইন্টারফেসে পাশাপাশি দেখুন। সহজে তুলনা করুন এবং আপনাকে সেরা সিদ্ধান্তে পৌঁছাতে সাহায্য করুন।
![](../../images/previews/en/image12.png)

### ওয়ান-ক্লিক লঞ্চার বল
ডেস্কটপে ফ্লোটিং বলে ক্লিক করুন ChatClaw প্রধান অ্যাপ্লিকেশন উইন্ডো তাৎক্ষণিকভাবে জাগানো বা খুলতে।
